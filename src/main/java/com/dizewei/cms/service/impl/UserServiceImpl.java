...
public class UserServiceImpl implements UserService{
	...
	@Override
	public PageInfo<Collect> selectCollect(Collect collect, Integer pageNum, Integer pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		
		List<Collect> coll = userDao.selectCollect(collect);
		return new PageInfo<Collect>(coll);
	}
